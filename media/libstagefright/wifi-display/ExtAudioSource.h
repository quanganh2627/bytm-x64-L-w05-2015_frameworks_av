...
#ifndef EXT_AUDIO_SOURCE_H_

#define EXT_AUDIO_SOURCE_H_
...
struct ExtAudioSource : public MediaSource, public MediaBufferObserver {
...
protected:
    virtual ~ExtAudioSource();

private:
    enum {
        kMaxBufferSize = 2048 * 5,
    ...
    ExtAudioSource(const ExtAudioSource &);
    ExtAudioSource &operator=(const ExtAudioSource &);
};

}  // namespace android

#endif  // EXT_AUDIO_SOURCE_H_