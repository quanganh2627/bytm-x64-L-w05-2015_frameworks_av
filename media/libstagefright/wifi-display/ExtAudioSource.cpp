...
static void AudioRecordCallbackFunction(int event, void *user, void *info) {
    ExtAudioSource *source = (ExtAudioSource *) user;
    switch (event) {
...
status_t ExtAudioSource::initCheck() const {
    return mInitCheck;
}

status_t ExtAudioSource::start(MetaData *params) {
...
void ExtAudioSource::releaseQueuedFrames_l() {
...
void ExtAudioSource::waitOutstandingEncodingFrames_l() {
...
sp<MetaData> ExtAudioSource::getFormat() {
    Mutex::Autolock autoLock(mLock);
    if (mInitCheck != OK) {
        return 0;
    }
...
void ExtAudioSource::rampVolume(
...
void ExtAudioSource::signalBufferReturned(MediaBuffer *buffer) {
...
status_t ExtAudioSource::dataCallback(const AudioRecord::Buffer& audioBuffer) {
...
void ExtAudioSource::queueInputBuffer_l(MediaBuffer *buffer, int64_t timeUs) {
...
int16_t ExtAudioSource::getMaxAmplitude() {
