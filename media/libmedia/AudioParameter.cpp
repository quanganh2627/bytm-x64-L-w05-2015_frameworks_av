...
const char * const AudioParameter::keyBGMSession = AUDIO_PARAMETER_VALUE_REMOTE_BGM_SESSION;
const char * const AudioParameter::keyBGMOutput = AUDIO_PARAMETER_VALUE_REMOTE_BGM_OUTPUT;
