...
// The interface file for inserting hooks to
// communicate with native service securitydevice
...
status_t CameraService::connect(
    ...
    bool allow = AsfDeviceAosp::sendCameraEvent(IPCThreadState::self()->getCallingUid(),
